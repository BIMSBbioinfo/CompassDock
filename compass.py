...
sys.path.append('/fast/AG_Akalin/asarigun/Arcas_Stage_1/DiffDock_Compass_Develop/AA_Score_Tool/')
# Ensure the path is correctly added. This path should be to the directory containing the PoseCheck module.
sys.path.append('/fast/AG_Akalin/asarigun/Arcas_Stage_1/DiffDock_Compass_Develop/posecheck/')

# export PYTHONPATH="/p/project/hai_bimsb_dock_drug/Arcas_Stage_1/diffdock_new_version:$PYTHONPATH"
path_to_add = "/fast/AG_Akalin/asarigun/Arcas_Stage_1/DiffDock_Compass_Develop"
