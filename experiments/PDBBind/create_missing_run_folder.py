...
text_file_path = '/fast/AG_Akalin/asarigun/Arcas_Stage_1/ROOF/COMPASS/experiments/PDBBind/data/missing_runs.txt'

# Directory containing your original .pdb files
source_directory = '/fast/AG_Akalin/asarigun/Arcas_Stage_1/ROOF/PROTEIN_DB/PDBBind_processed'

# Target directory where you want to copy the .pdb files
target_directory = '/fast/AG_Akalin/asarigun/Arcas_Stage_1/ROOF/PROTEIN_DB/PDBBind_processed_missing_RUNS'
