...
#$ -pe smp 1
#$ -o /fast/AG_Akalin/asarigun/Arcas_Stage_1/FACTORY/RESULTS/TREAMID_PDBBIND/job_outputs/
#$ -e /fast/AG_Akalin/asarigun/Arcas_Stage_1/FACTORY/RESULTS/TREAMID_PDBBIND/job_errors/
#$ -t 1-19119 # Adjust this range to the number of lines in "run.lst" - check "wc -l run.lst"
...
SCRIPT=$(sed "${SGE_TASK_ID}q;d" < /fast/AG_Akalin/asarigun/Arcas_Stage_1/FACTORY/RUNS/TREAMID_PDBBIND/run.lst)
