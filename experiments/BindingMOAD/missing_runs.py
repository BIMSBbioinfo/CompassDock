...
filtered_csv_path = '/fast/AG_Akalin/asarigun/Arcas_Stage_1/ROOF/COMPASS/experiments/BindingMOAD/data/filtered_summary_new_rec_1.csv'  # Update this path
filtered_df = pd.read_csv(filtered_csv_path)

# Directory containing your .pdb files
pdb_directory = '/fast/AG_Akalin/asarigun/Arcas_Stage_1/ROOF/PROTEIN_DB/BindingMOAD_2020_processed/'
...
output_file_path = '/fast/AG_Akalin/asarigun/Arcas_Stage_1/ROOF/COMPASS/experiments/BindingMOAD/missing_runs.txt'  # Update this path
