...
SCRIPTS_FOLDER="/p/project/hai_bimsb_dock_drug/Arcas_Stage_1/ROOF/FACTORY/RUNS/TREAMID_BindingMOAD"
...
#SBATCH --output=/p/project/hai_bimsb_dock_drug/Arcas_Stage_1/ROOF/FACTORY/RESULTS/TREAMID_BindingMOAD/job_outputs/%j.out # Standard output path
#SBATCH --error=/p/project/hai_bimsb_dock_drug/Arcas_Stage_1/ROOF/FACTORY/RESULTS/TREAMID_BindingMOAD/job_errors/%j.err  # Standard error path
...
python -W ignore -m main_multi_shot \
  ...
  --protein_dir /p/project/hai_bimsb_dock_drug/Arcas_Stage_1/ROOF/PROTEIN_DB/BindingMOAD_2020_processed/pdb_protein \
  --ligand_description "C1=CN=C(N1)CCNC(=O)CCCC(=O)NCCC2=NC=CN2" \
  --out_dir /p/project/hai_bimsb_dock_drug/Arcas_Stage_1/ROOF/FACTORY/RESULTS/TREAMID_BindingMOAD/results/ \
  --max_recursion_step 5 \
  --wandb_path /p/project/hai_bimsb_dock_drug/Arcas_Stage_1/ROOF/FACTORY/RESULTS/TREAMID_BindingMOAD \
  --start $START \
  --end $END
