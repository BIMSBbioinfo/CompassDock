...
# Directories
main_dir="/fast/AG_Akalin/asarigun/Arcas_Stage_1/PROTEIN_DB/HuRI"
factor_dir="/fast/AG_Akalin/asarigun/Arcas_Stage_1/FACTORY/RUNS/TREAMID_HURI"
...
#$ -l h_rt=00:45:00
#$ -pe smp 1
#$ -e /fast/AG_Akalin/asarigun/Arcas_Stage_1/FACTORY/RESULTS/TREAMID_HURI/log_\$JOB_ID.err
#$ -o /fast/AG_Akalin/asarigun/Arcas_Stage_1/FACTORY/RESULTS/TREAMID_HURI/log_\$JOB_ID.out
...
python -W ignore -m main_multi_shot \
  ...
  --out_dir /fast/AG_Akalin/asarigun/Arcas_Stage_1/FACTORY/RESULTS/TREAMID_HURI/results/ \
  --max_recursion_step 5 \
  --wandb_path /fast/AG_Akalin/asarigun/Arcas_Stage_1/FACTORY/RESULTS/TREAMID_HURI
