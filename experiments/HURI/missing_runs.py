...
filtered_csv_path = '/fast/AG_Akalin/asarigun/Arcas_Stage_1/ROOF/COMPASS/experiments/HURI/data/filtered_summary_new_rec_1.csv'  # Update this path
filtered_df = pd.read_csv(filtered_csv_path)

# Directory containing your .pdb files
pdb_directory = '/fast/AG_Akalin/asarigun/Arcas_Stage_1/ROOF/PROTEIN_DB/HuRI'
...
output_file_path = '/fast/AG_Akalin/asarigun/Arcas_Stage_1/ROOF/COMPASS/experiments/HURI/missing_runs.txt'  # Update this path
